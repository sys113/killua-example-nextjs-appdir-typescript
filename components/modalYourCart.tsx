  ...
  return (
    <>
      {thunderCartIsReadyInSsr && (
        <div
          className={`duration-400 fixed left-0 right-0 top-0 bottom-0 z-[60] flex h-screen w-screen items-center justify-center backdrop-blur-[2px] transition-all ${
            props.isOpenModal ? 'visible bg-black/50' : 'invisible opacity-0'
          }`}
        >
          <div
              ...
              <div className="w-full lg:w-[400px]">
                ...
                {thunderCartSelectors.cartIsEmpty() ? (
                  <div className="flex flex-col items-center gap-4 pb-4 pt-8">
                    <Image src={cartIsEmpty} width={200} alt="cart is empty" />
